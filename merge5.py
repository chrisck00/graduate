...
MERGED_MODEL = "./merged_models/merged_model_5"

base_model_name = BASE_MODEL
finetuned_model_name1 = HELLA_MODEL
finetuned_model_name2 = RTE_MODEL
finetuned_model_name3 = COQA_MODEL
finetuned_model_name4 = BOOLQ_MODEL
finetuned_model_name5 = QQP_MODEL
...
def compute_role_drop_rates(delta: dict, role_rms: dict, combined_minmax: dict, default_drop_rate=0.7, drop_scale=4):
    """
    delta: {key: tensor}
    role_rms: {role: {key: rms}}
...
role_rms4, role_minmax4, delta4 = compute_role_rms(base_model_name, finetuned_model_name4, device)
role_rms5, role_minmax5, delta5 = compute_role_rms(base_model_name, finetuned_model_name5, device)
...
role_minmax_list = [role_minmax1, role_minmax2, role_minmax3, role_minmax4, role_minmax5]
...
role_drop_rates4 = compute_role_drop_rates(delta4, role_rms4, combined_minmax)
role_drop_rates5 = compute_role_drop_rates(delta5, role_rms5, combined_minmax)
...
delta_dropped4 = apply_delta_drop(delta4, role_drop_rates4)
delta_dropped5 = apply_delta_drop(delta5, role_drop_rates5)
"""
print(f"\n===================================================\n")
...
merged_delta = merge_with_rms_filter(
    [delta_dropped1, delta_dropped2, delta_dropped3, delta_dropped4, delta_dropped5],
    [role_drop_rates1, role_drop_rates2, role_drop_rates3, role_drop_rates4, role_drop_rates5],
    [role_rms1, role_rms2, role_rms3, role_rms4, role_rms5],
)
