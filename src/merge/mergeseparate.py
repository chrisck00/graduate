...
finetuned_model_name2 = COQA_MODEL
finetuned_model_name3 = PIQA_MODEL
...
def compute_role_drop_rates(delta: dict, role_rms: dict, combined_minmax: dict, default_drop_rate=0.9, drop_scale=0):
    """
    delta: {key: tensor}
    role_rms: {role: {key: rms}}
...
role_drop_rates1 = compute_role_drop_rates(delta1, role_rms1, role_minmax1)
role_drop_rates2 = compute_role_drop_rates(delta2, role_rms2, role_minmax2)
role_drop_rates3 = compute_role_drop_rates(delta3, role_rms3, role_minmax3)
